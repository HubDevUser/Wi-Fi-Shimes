...
//  CameraCop
//
//  Created by Abdulrahim Charif on 8/12/17.
//  Copyright © 2017 Abdulrahim Charif. All rights reserved.
//
...
class MainVC: UIViewController, MainPresenterDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func refresh(_ sender: Any) {
        ...
        self.navigationBarTitle.title = "test"
            //self.presenter.ssidName()
    ...
    func mainPresenterIPSearchFinished() {
        ...
        self.showAlert(title: "Scan Finished", message: "Number of devices connected to the Local Area Network : \(self.presenter.connectedDevices.count), please select CameraCop device")
    }
